      ...
      <div className="mx-auto max-w-[1540px] space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.65fr_0.8fr]">
          ...
          <aside className="space-y-5 xl:sticky xl:top-6 xl:self-start">
            ...
            <div className="app-surface-panel rounded-[28px] p-5"><div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.26em] text-slate-500"><Flame className="h-3.5 w-3.5 text-primary" />Perfil metabolico</div><div className="mt-4 grid gap-3"><div className="grid grid-cols-2 gap-3"><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Sexo</div><div className="mt-2 text-sm text-white">{metabolicProfile?.sex === "female" ? "Femenino" : "Masculino"}</div></div><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Edad</div><div className="mt-2 text-sm text-white">{metabolicProfile?.age ?? "--"} anos</div></div></div><div className="grid grid-cols-2 gap-3"><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Peso</div><div className="mt-2 text-sm text-white">{formatMetric(metabolicProfile?.weightKg, " kg", 1)}</div></div><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Altura</div><div className="mt-2 text-sm text-white">{formatMetric(metabolicProfile?.heightCm, " cm", 0)}</div></div></div><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Actividad</div><div className="mt-2 text-sm text-white">{ACTIVITY_LABELS[metabolicProfile?.activityLevel ?? "moderate"] ?? "--"}</div></div><div className="rounded-2xl border app-surface-soft p-3"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Objetivo</div><div className="mt-2 text-sm text-white">{GOAL_LABELS[metabolicProfile?.goalType ?? "maintain"] ?? "--"}</div></div><Button asChild className="rounded-2xl bg-primary text-primary-foreground hover:bg-primary/90"><Link to="/fitness-profile">Abrir Perfil Fitness</Link></Button></div></div>
          </aside>
        </div>
      </div>
